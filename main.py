...
async def check_price():
    ...
    stop_loss_threshold_percent = 0.8
        ...
        if current_buy_price_devt > 0:
            ...
            if price_change_percent_devt >= target_profit_percent:
                ...
                while True:
                    ...
                    if price_change_percent_devt >= target_profit_percent + profit_threshold_increment:
                    ...
                    if price_change_percent_devt <= sell_threshold_percent_devt:
                        logger.info(f"Price retraced to {price_change_percent_devt:.2f}% for DEVTUSDT. Selling DEVT.")
                ...
                logger.info(f"Price dropped below {stop_loss_threshold_percent}% for DEVTUSDT. Selling all DEVT.")
                symbol_balance_devt = get_wallet_balance("DEVT")
                if symbol_balance_devt > 10:
                    symbol_balance_devt = math.floor(symbol_balance_devt)
                    close_position("DEVTUSDT", symbol_balance_devt)
